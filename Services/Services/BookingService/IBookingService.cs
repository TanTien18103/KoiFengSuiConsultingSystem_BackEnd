...
namespace Services.Services.BookingService
{
    ...
    {
        // Booking Online
        Task<ResultModel> GetBookingOnlineById(string id);
        ...
        Task<ResultModel> UpdateCompletedBookingOnline(string id);
        // Booking Offline
        Task<ResultModel> GetBookingOfflineById(string id);
